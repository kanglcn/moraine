...
# %% ../../nbs/CLI/plot.ipynb 93
def ts_plot(
    v:str, # path to pc dataset
    t, # temporal coordinate
    source_plot, # source plot
    kdtree=None, # kdtree, optional
    y:str=None, # path to y coordinate, must be provided if kdtree is not provided
    x:str=None, # path to x coordinate, must be provided if kdtree is not provided
