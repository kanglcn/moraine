...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'decorrelation.co': { 'decorrelation.co._isPD': ('API/co.html#_ispd', 'decorrelation/co.py'),
                                  'decorrelation.co.emperical_co': ('API/co.html#emperical_co', 'decorrelation/co.py'),
